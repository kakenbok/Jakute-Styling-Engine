package selectorapi.selectortest {
	...
	public class Box extends JCSS_Sprite {
		...
		override protected function jcss_onStylesInitialized() : void {
			_active = jcss_getState("active") == "true";
			...
			_checkBox.setSize(12, 12);
			_checkBox.moveTo(4, 4);
			_checkBox.selected = _active;
			_checkBox.addEventListener(ButtonEvent.SELECTION_CHANGED, checkBoxChangedHandler);
			addChild(_checkBox);
		...
		private function checkBoxChangedHandler(event : ButtonEvent) : void {
			_active = !_active;
